...
# Bad design here. Looking for the side effect of loading environment variables
...
# model_id="deepseek-r1:1.5b" # Just kidding. ollama.com says yes, but the interface says no for tools.
model_id="llama3.2:3b"
model_id="qwen3:1.7b"
model = init_chat_model(model_id, model_provider="ollama", api_key=api_key)
...
try:
    ...
    print("Please ensure your *_API_KEY is correct and the LangChain packages are installed.")
